...
public class OI {
	...
	public OI() {
		if (useDancepad) {
			...
			/* long */
			new JoystickButton(dancepad, dancepadStart).whenPressed(new MoveArm(1.0, 220)); // up
																							// fast
			/* short */
			new JoystickButton(dancepad, dancepadCircle).whenPressed(new MoveArm(0.7, 220)); // up
																								// slow
			...
			new JoystickButton(joystickRight, joystickTrigger).whenPressed(new MoveArm(.9, 220)); // up
																									// fast
